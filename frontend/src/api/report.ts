...
// 월경 알림 메시지 조회
export async function getPeriodAlert() {
  try {
...
// 배란테스트 결과 조희
export async function getOvulationTest() {
  try {
...
// 최근 6개월 간 월경 주기 조희
export async function getRecentPeriod() {
  try {
...
// 최근 3개월 간 복용약 조회
export async function getRecentMedicine() {
  try {
