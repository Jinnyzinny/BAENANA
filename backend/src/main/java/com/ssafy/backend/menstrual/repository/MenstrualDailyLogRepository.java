...
public interface MenstrualDailyLogRepository extends JpaRepository<MenstrualDailyLog, Long> {
    ...
    Optional<MenstrualDailyLog> findByCycle_User_UserIdAndDate(Long userId, LocalDate searchForDate);

    Boolean existsByCycle_User_UserIdAndDate(Long userId, LocalDate searchForDate);
}
